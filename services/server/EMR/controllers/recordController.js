...
async function createRecord(req, res) {   
  ...
  try {
    ...
    const ClinicID = 1;  //Get clinicID from appointment service
    const PatientID = 1;  //Get patientID from appointment service
    const RDate = "2024-04-24";     //Get appointmentDate from appointment service
