    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex flex-1">
                ...
                <div className="w-5/6 justify-center flex flex-1 overflow-y-auto">
                    <div className="w-full max-w-xl">
                        <div className="h-full block bg-white px-4 sm:px-6 lg:px-8 py-12 sm:py-20 rounded-md shadow-xl">
